...
export default function DashboardPage() {
  ...
  const onDrop = useCallback(async (acceptedFiles: File[]) => {
    ...
    try {
      ...
      if (text.length < 50) {
        setPdfError(
          "Could not extract enough text from this PDF. Try a different file."
        );
        setIsParsing(false);
        return;
      }
  ...
  // ── Analyze ─────────────────────────────────
  const canAnalyze =
    resumeText && jobDescription.trim().length >= 50 && !isAnalyzing;
  ...
  return (
    <div className="min-h-screen bg-[#F0F6FD]">
      {/* ── Header ─────────────────────────────── */}
      ...
      <main className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
                  ...
                  <div
                    ...
                    className={`flex cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed p-8 transition-colors ${
                      isDragActive
                        ...
                        : "border-gray-300 bg-gray-50 hover:border-[#00ABE4] hover:bg-[#E9F1FA]/50"
                    }`}
                  >
                    <input {...getInputProps()} />
                    {isParsing ? (
            ...
            <Card className="border-gray-200 bg-white shadow-sm">
              ...
              <CardContent>
                <textarea
                  ...
                  className="min-h-[200px] w-full resize-y rounded-xl border border-gray-300 bg-white p-4 text-sm text-gray-900 placeholder:text-gray-400 focus:border-[#00ABE4] focus:outline-none focus:ring-2 focus:ring-[#00ABE4]/20"
                />
        ...
        {result && (
          <div className="space-y-6 animate-fade-in-up">
            ...
            {/* Resume Summary */}
            <Card className="border-[#00ABE4]/20 bg-gradient-to-r from-[#E9F1FA] to-white shadow-sm">
            ...
            {/* Tabs: Suggestions, Interview, Cover Letter */}
                    ...
                    <ul className="space-y-3">
                      {result.resumeSuggestions.map((s, i) => (
                        <li key={i} className="flex gap-3">
                          <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#E9F1FA] text-xs font-bold text-[#00ABE4]">
                            {i + 1}
                          </span>
              ...
              <TabsContent value="cover-letter">
                <Card className="border-gray-200 bg-white shadow-sm">
                  ...
                  <CardContent>
                    ...
                    <div className="whitespace-pre-wrap rounded-xl border border-gray-100 bg-white p-6 text-sm leading-relaxed text-gray-800">
                      {result.coverLetter}
                    </div>
                  </CardContent>
                </Card>
