...
export function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#E9F1FA] via-white to-[#E9F1FA] pt-28 pb-20 sm:pt-36 sm:pb-28">
      {/* Decorative blobs */}
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6">
        {/* Badge */}
        <div className="animate-fade-in-up mb-6 inline-flex items-center gap-2 rounded-full border border-[#00ABE4]/20 bg-white px-4 py-1.5 text-sm font-medium text-[#00ABE4] shadow-sm">
          <Sparkles className="h-4 w-4" />
          AI-Powered Resume Analysis
        </div>

        {/* Headline */}
        <h1 className="animate-fade-in-up-delay-1 text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl lg:text-6xl">
          Land Your Dream Job with{" "}
          <span className="text-[#00ABE4]">AI-Powered</span> Insights
        </h1>

        {/* Subheadline */}
        <p className="animate-fade-in-up-delay-2 mx-auto mt-6 max-w-2xl text-lg text-gray-600 sm:text-xl">
